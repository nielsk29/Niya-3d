...
pi2=pi*2  # 2pi
nbRay = 640 # nombre de rayons qu'on envoie
...
listeObjet = [[1, 350, 150,0],  [0, 150, 1350,0 ],  [0, 850, 1350,0 ],
               ...
               [0, 1650, 1250,0 ],  [0, 1550, 1350,0 ],  [0, 1650, 1350,0 ]]        # liste emplacement objet sous forme (objet,posX,posY)
...
listeParametreObjet = [(50,2.50, 100,50),(30,-1, 40,1000)]
vieObjet = []
lObjAnim = []
