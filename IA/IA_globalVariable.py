...
gameX = 1500  #taille X de la carte
gameY = 700  #taille Y de la carte
playerX = 1250 # Position X du joueur
playerY = 350  # position Y du joueur
...
carteSize = (15, 7)  # taille X et Y de la carte (en carré)
...
listeRond = []  # liste des point d'intersection utiliser pour la minimap
         ...
         #0;2;4;6;8;0;2;4
Carte = ("111111111111111"#0
         "100000000000001"#1
         "100000000000001"#2
         "100000030000001"#3
         "100000000000001"#4
         "100000000000001"#5
         "111111111111111"#6               # carte avec 1 = mur / 0 = rien / 2 = Porte / 3 = portail de fin
        )
         #;1;3;5;7;9;1;3;
nbPorte = Carte.count('2')  # nombre de porte
nbPortal = Carte.count('3')  # nombre de portail

listeObjet = []        # liste emplacement objet sous forme [indice dans la liste des image,posX,posY, frame]
listeMonstre = []#[0,450,350,0],[0,850,350,0]
...
for element in listeMonstre:
    statusMonstre.append([False, False, 0,False,0, False, [0,0], [0,0], math.pi])  #[visible, animation tir, temps dernier tir, à tirer, attente prochain tir, en mouvement, direction(cos,sin), point arriver, oriantation]
...
playerVie = 1000  #vie du joueur qui sera <=100
...
imageRocket = [pygame.image.load("../image/rocket/face.png"),
               pygame.image.load("../image/rocket/coteFace.png"), pygame.image.load(
        "../image/rocket/coteFaceReverse.png"),
               ...
               pygame.image.load("../image/rocket/coteBack.png"), pygame.image.load(
        "../image/rocket/coteBackReverse.png"),
...
pygame.display.flip()
listeRectLarge, listeRectPos = IA_chargement.calculPlaceRayonSurEcran()        #utilisation d'une fonction qui va calculer la position et la largeur de chaque rectangle affiché sur l'écran pour chaque IA_Rayo
...
IA_chargement.charg()  #chargement de beacoup d'image
